      ...
      {editing ? (
        <form className={styles.form}>
          ...
          <input
            ...
            onChange={handleInputChange}
            className={`${styles.wordInput} ${
              !values.transcription ? styles.error : ''
            }`}
          ...
          <button
            ...
            disabled={
              !values.english || !values.transcription || !values.russian
            }
        ...
        <div
          className={`${styles.word} ${selected ? styles.selected : ''}`}
        ...
        >
          ...
          >
            <img className={styles.trash} src={trashIcon} alt='Delete' />
          </button>
        </div>
      )}
    </div>
